...
public class PumpkinAnimation extends KeyAdapter implements ActionListener {
    ...
    PumpkinAnimation(Pumpkin pumpkin) {
        this.mouseTransformGroup = pumpkin.getPumpkinTransformGroup();
